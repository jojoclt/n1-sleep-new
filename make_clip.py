...
def clip_edf_data(psg_id, hypnogram_id, read_folder, write_folder, duration_before=10):
    ...
    # print(signal_df[signal_df.iloc[:,3].isnull()])
    # exit()
        ...
        if (
            ...
            if annotation_clip["Onset"].iloc[0] == 0.0:
                ...
                if duration_before == None:
                    ...
                    total_duration_in_sec = duration_before * 60
                    annotation_clip["Onset"].iloc[0] = (
                        annotation_clip["Onset"].iloc[1] - total_duration_in_sec
                    )
                    annotation_clip["Duration"].iloc[0] = total_duration_in_sec
...
if duration_before == None:
    ...
    write_folder += f"{duration_before}/"
    
os.makedirs(write_folder, exist_ok=True)
pattern1 = "*-PSG.edf"
pattern2 = "*-Hypnogram.edf"

print(f"CUT DURATION {duration_before}")
