...
# read_folder = './clips/'
# write_folder = f'./plots_n1_eeg_{EEG_THRES}_EEGCONSEC_{EEG_CONSEC}_eog_{EOG_THRES}_EEGCONSEC_{EOG_CONSEC}/'

read_folder = './clips_front_extend_30m/'
write_folder = f'{read_folder[:-1]}_EEG_{EEG_THRES}_EEGCONSEC_{EEG_CONSEC}_EEGTOTALSIZE_{EEG_TOTAL_SIZE}_EOG_{EOG_THRES}_EOGCONSEC_{EOG_CONSEC}_/'
